...
it('lets 2 users exchange stars', async() => {
    ...
    star1Owner = await instance.ownerOf(starId1);
    star2Owner = await instance.ownerOf(starId2);
...
it('lets a user transfer a star', async() => {
    ...
    starOwner = await instance.ownerOf(starId);
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(info, "awesome star")
});